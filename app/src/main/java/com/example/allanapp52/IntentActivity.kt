...
// End of TopAppbar
        ...
        OutlinedButton(
            ...
            Text(text = "MPESA", color = Color.Red)
        }
        ...
        OutlinedButton(
            ...
            Text(text = "CAMERA", color = Color.Red,)
        }
        Spacer(modifier = Modifier.height(15.dp))
        ...
        OutlinedButton(
            onClick = {
                val shareIntent = Intent(Intent.ACTION_SEND)
                shareIntent.type = "text/plain"
                shareIntent.putExtra(Intent.EXTRA_EMAIL, arrayOf("allankamau0254@gmail.com"))
        ...
        OutlinedButton(
            onClick = {
                ...
                smsIntent.putExtra("sms_body","Hello Allan,how are you doing?")
        ...
        OutlinedButton(
            onClick = {
                ...
                callIntent.data="tel:0723814218".toUri()
            ...
            Text(text = "CALL", color = Color.Red)
        }
        Spacer(modifier = Modifier.height(15.dp))
        ...
        OutlinedButton(
            ...
            Text(text = "SHARE", color = Color.Red)
        }
        Spacer(modifier = Modifier.height(15.dp))
